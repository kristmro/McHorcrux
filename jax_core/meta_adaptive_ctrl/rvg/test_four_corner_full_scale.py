...
segments = [
    # 1. [20.0, 20.0, 0.0] for 10 seconds (steady DP station-keeping)
    {'type': 'dwell', 'point': jnp.array([20.0, 20.0, 0.0]), 'time': 10.0},

    # 2. Translate 20 m east (slow, careful motion)
    {'type': 'transition', 'start': jnp.array([20.0, 20.0, 0.0]), 'end': jnp.array([40.0, 20.0, 0.0]), 'time': 60.0},

    # 3. Dwell (steady DP) at east point
    {'type': 'dwell', 'point': jnp.array([40.0, 20.0, 0.0]), 'time': 20.0},

    # 4. Translate 20 m north
    {'type': 'transition', 'start': jnp.array([40.0, 20.0, 0.0]), 'end': jnp.array([40.0, 40.0, 0.0]), 'time': 60.0},

    # 5. Dwell at northeast corner
    {'type': 'dwell', 'point': jnp.array([40.0, 40.0, 0.0]), 'time': 25.0},

    # 6. Rotate in place by -π/4 (careful orientation change)
    {'type': 'transition', 'start': jnp.array([40.0, 40.0, 0.0]), 'end': jnp.array([40.0, 40.0, -jnp.pi/4]), 'time': 30.0},

    # 7. Dwell with new heading
    {'type': 'dwell', 'point': jnp.array([40.0, 40.0, -jnp.pi/4]), 'time': 20.0},

    # 8. Translate westward (20 m)
    {'type': 'transition', 'start': jnp.array([40.0, 40.0, -jnp.pi/4]), 'end': jnp.array([20.0, 40.0, -jnp.pi/4]), 'time': 60.0},

    # 9. Dwell west side
    {'type': 'dwell', 'point': jnp.array([20.0, 40.0, -jnp.pi/4]), 'time': 20.0},

    # 10. Final transition + heading reset
    {'type': 'transition', 'start': jnp.array([20.0, 40.0, -jnp.pi/4]), 'end': jnp.array([20.0, 20.0, 0.0]), 'time': 90.0},

    # 11. Final station-keeping
    {'type': 'dwell', 'point': jnp.array([20.0, 20.0, 0.0]), 'time': 30.0},
]
...
if __name__ == "__main__":
    ...
    # Save the figure
    output_dir = 'figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}'.format(
    ...
    output_path = os.path.join('data', 'testing_results','rvg','model_uncertainty','full_scale','div','{}'.format(args.hs),'{}'.format(args.tp),'train_act_{}'.format(act),'four_corner','test_act_{}'.format(test_act),'ctrl_pen_{}'.format(ctrl_pen),'seed={}_M={}.pkl'.format(seed, M))
    ...
    with open('data/testing_results/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}.pkl'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), 'rb') as file:
        results = pickle.load(file)

    # Create figures directory if it doesn't exist
    os.makedirs('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen, seed, M), exist_ok=True)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/position_tracking.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/trajectory_2d.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/tracking_errors.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_cmd.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    axes4[2].set_xlabel('Time (s)')
    plt.tight_layout()
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_u_after.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    ax5.legend()
    plt.tight_layout()
    plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_norm.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    if len(methods) > 1:  # Only make comparison if we have multiple methods
        ...
        ax5.legend()
        plt.tight_layout()
        plt.savefig('figures/rvg/model_uncertainty/full_scale/div/{}/{}/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/rms_error_comparison.png'.format(args.hs,args.tp,act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
