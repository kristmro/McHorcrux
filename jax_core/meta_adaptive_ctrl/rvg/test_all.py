...
from jax_core.meta_adaptive_ctrl.rvg.dynamics import disturbance, plant, prior_3dof as prior
...
if __name__ == '__main__':
    ...
    hs_min = hparams['hs_min']  #hs_min
    hs_max = hparams['hs_max'] #hs_max
    tp_min = hparams['tp_min']  #tp_min
    tp_max = hparams['tp_max']  #tp_max
    ...
    filename = os.path.join('data', 'training_results','rvg', 'act_off','ctrl_pen_6',
    ...
    os.makedirs('data/testing_results/rvg/all/act_off/ctrl_pen_6', exist_ok=True)
    output_filename = os.path.join(
        'data', 'testing_results','rvg', 'all', 'act_off', 'ctrl_pen_6',
