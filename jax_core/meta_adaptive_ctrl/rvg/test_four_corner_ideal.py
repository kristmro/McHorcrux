...
if __name__ == "__main__":
    ...
    w = disturbance(jnp.array((0.0, 19.0, 0)), key)
    ...
    # Save the figure
    output_dir = 'figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}'.format(
    ...
    output_path = os.path.join('data', 'testing_results','rvg','hs0','train_act_{}'.format(act),'four_corner','test_act_{}'.format(test_act),'ctrl_pen_{}'.format(ctrl_pen),'seed={}_M={}.pkl'.format(seed, M))
    ...
    with open('data/testing_results/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}.pkl'.format(act,which_test,test_act,ctrl_pen,seed,M), 'rb') as file:
        results = pickle.load(file)

    # Create figures directory if it doesn't exist
    os.makedirs('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}'.format(act,which_test,test_act,ctrl_pen, seed, M), exist_ok=True)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/position_tracking.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/trajectory_2d.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/tracking_errors.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_cmd.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    axes4[2].set_xlabel('Time (s)')
    plt.tight_layout()
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_u_after.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    ax5.legend()
    plt.tight_layout()
    plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/control_efforts_norm.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
    ...
    if len(methods) > 1:  # Only make comparison if we have multiple methods
        ...
        ax5.legend()
        plt.tight_layout()
        plt.savefig('figures/rvg/hs0/train_act_{}/{}/test_act_{}/ctrl_pen_{}/seed={}_M={}/rms_error_comparison.png'.format(act,which_test,test_act,ctrl_pen,seed,M), dpi=300)
