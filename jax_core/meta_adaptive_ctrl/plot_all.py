...
----------------------------------------------------------------------
Author:  *you* – adapted from Spencer M. Richards’ original plotting code.
"""
...
ROOT_RESULTS = Path("data/testing_results/all/act_off/ctrl_pen_3")
...
def main():
    ...
    parser.add_argument("--seed-range", type=str, default="0:3",
